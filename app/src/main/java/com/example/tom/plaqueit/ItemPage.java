...
public class ItemPage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflatedView = inflater.inflate(R.layout.fragment_item_page, container, false);

        plaqueTitle = (TextView)inflatedView.findViewById(R.id.plaque_title);
        plaqueDesc = (TextView)inflatedView.findViewById(R.id.plaque_description);
